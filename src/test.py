...
# add layers
im2 = plt.imread('/Users/dirkhovy/Dropbox/working/lowlands/sociolinguistics/movement/data/annotations/V_NKI_FA.png')
im3 = plt.imread('/Users/dirkhovy/Dropbox/working/lowlands/sociolinguistics/movement/data/annotations/V_NKI_FP.png')
